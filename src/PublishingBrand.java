public class PublishingBrand extends MyArrayElement implements IPublishingArtifact{

    private String name;
    private MyArrays books;

    public PublishingBrand(Integer id, String name) {

        this.id = id;
        this.name = name;
        this.books = new MyArrays(new Book[0]);
